...
Get started with setting up permissions to access data with [ORDA](https://us.4d.com/orda) REST (4D v19 R8)

Find more information on the [blog post](https://blog.4d.com/filter-access-to-your-data-with-a-complete-system-of-permissions/).
